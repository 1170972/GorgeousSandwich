...
import pt.isep.arqsoft.GorgeousSandwich.repository.review.wrapper.IReviewRepositoryWrapper;
...
public class ReviewController {
    private IReviewRepositoryWrapper<Review> reviewRepository;
    private ReviewConverter reviewConverter;

    public ReviewController(IReviewRepositoryWrapper<Review> reviewRepository, ReviewConverter reviewConverter){
