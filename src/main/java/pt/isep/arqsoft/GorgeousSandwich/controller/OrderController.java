...
import pt.isep.arqsoft.GorgeousSandwich.repository.order.wrapper.IOrderRepositoryWrapper;
import pt.isep.arqsoft.GorgeousSandwich.repository.sandwich.wrapper.ISandwichRepositoryWrapper;
...
public class OrderController {
    ...
    private IOrderRepositoryWrapper<Order> orderRepository;
    
    private ISandwichRepositoryWrapper<Sandwich> sandwichRepository;
    
    private OrderConverter orderConverter;

    public OrderController(IOrderRepositoryWrapper<Order> orderRepository,ISandwichRepositoryWrapper<Sandwich> sandwichRepository, OrderConverter orderConverter){
