...
import pt.isep.arqsoft.GorgeousSandwich.repository.comment.wrapper.ICommentRepositoryWrapper;
...
public class CommentController {
    private ICommentRepositoryWrapper<Comment> commentRepository;
    private CommentConverter commentConverter;

    public CommentController(ICommentRepositoryWrapper<Comment> commentRepository,CommentConverter commentConverter){
